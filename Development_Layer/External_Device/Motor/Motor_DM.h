//
// Created by 24158 on 2026/6/7.
//

#ifndef RC_ROBOTDOG_REBUILD20260605_MOTOR_DM_H
#define RC_ROBOTDOG_REBUILD20260605_MOTOR_DM_H
...
struct Struct_Motor_DM_Rx_Data_Normal {
  Enum_Motor_DM_Control_Status_Normal Control_Status = Motor_DM_Control_Status_DISABLE;
  float Now_Angle;
  float Now_Omega;
  float Now_Torque;
...
public:
  void Init(CAN_HandleTypeDef *hcan, uint16_t __CAN_Rx_ID, uint16_t __CAN_Tx_ID,
            Enum_Motor_DM_Control_Method __Motor_DM_Control_Method =
                Motor_DM_Control_Method_NORMAL_MIT,
            float __Angle_Max = 3.1415926f, float __Omega_Max = 30.0f,
  ...
  inline uint16_t Get_CAN_Rx_ID();

  inline uint16_t Get_CAN_Tx_ID();
  ...
  void RTOS_Send_Callback();

  void Dog_Send_Callback();
...
protected:
  ...
  // 电机状态
  volatile Enum_Motor_DM_Status Motor_DM_Status = Motor_DM_Status_DISABLE;
  // 电机对外接口信息
...
public:
  ...
  void Init(CAN_HandleTypeDef *hcan,
            ...
            Enum_Motor_DM_Control_Method __Motor_DM_Control_Method =
                Motor_DM_Control_Method_1_TO_4_ANGLE,
            int32_t __Encoder_Offset = 0, float __Current_Max = 10.261194f);
  ...
  inline void
  Set_Control_Method(Enum_Motor_DM_Control_Method __DM_Motor_Control_Method);
  ...
  inline void Set_Encoder_Offset(float __Encoder_Offset);

  void CAN_RxCpltCallback(uint8_t *Rx_Data);

  void RTOS_100ms_Alive_Callback();

  void RTOS_Calculate_Callback();
 ...
 * @return float 角度最大值
 */
inline float Class_Motor_DM_Normal::Get_Angle_Max() { return (Angle_Max); }
 ...
 * @return float 角速度最大值
 */
inline float Class_Motor_DM_Normal::Get_Omega_Max() { return (Omega_Max); }
 ...
 * @return float 扭矩最大值
 */
inline float Class_Motor_DM_Normal::Get_Torque_Max() { return (Torque_Max); }
 ...
 * @return float 电流最大值
 */
inline float Class_Motor_DM_Normal::Get_Current_Max() { return (Current_Max); }


/**
 * @brief 获取接收用的CAN_RX_ID
 *
 * @return uint16_t CAN_RX_ID
 */
inline uint16_t Class_Motor_DM_Normal::Get_CAN_Rx_ID(){return (CAN_Rx_ID); }

/**
 * @brief 获取发送用的CAN_TX_ID
 *
 * @return uint16_t CAN_TX_ID
 */
inline uint16_t Class_Motor_DM_Normal::Get_CAN_Tx_ID(){return (CAN_Tx_ID); }
 ...
 */
inline Enum_Motor_DM_Control_Status_Normal
Class_Motor_DM_Normal::Get_Control_Status() {
 ...
 */
inline Enum_Motor_DM_Control_Method
Class_Motor_DM_Normal::Get_Control_Method() {
 ...
 */
inline float Class_Motor_DM_Normal::Get_K_P() { return (K_P); }
 ...
 */
inline float Class_Motor_DM_Normal::Get_K_D() { return (K_D); }
 ...
 *
 * @param __Control_Omega 角速度, rad/s, MIT模式和速度模式是目标角速度,
 * 其余模式是限幅
 */
 ...
 *
 * @param __Control_Torque 扭矩, Nm, MIT模式是目标扭矩, EMIT模式无效,
 * 其余模式是限幅
 */
 ...
 */
inline void
Class_Motor_DM_Normal::Set_Control_Current(float __Control_Current) {
 ...
 */
inline void Class_Motor_DM_Normal::Set_K_P(float __K_P) { K_P = __K_P; }
 ...
 */
inline void Class_Motor_DM_Normal::Set_K_D(float __K_D) { K_D = __K_D; }
 ...
 * @return float 电流最大值
 */
inline float Class_Motor_DM_1_To_4::Get_Current_Max() { return (Current_Max); }
 ...
 */
inline Enum_Motor_DM_Control_Method
Class_Motor_DM_1_To_4::Get_Control_Method() {
  return (Motor_DM_Control_Method);
}
 ...
 */
inline void Class_Motor_DM_1_To_4::Set_Control_Method(
    Enum_Motor_DM_Control_Method __DM_Motor_Control_Method) {
 ...
 */
inline void
Class_Motor_DM_1_To_4::Set_Feedforward_Omega(float __Feedforward_Omega) {
 ...
 */
inline void
Class_Motor_DM_1_To_4::Set_Feedforward_Current(float __Feedforward_Current) {
  Feedforward_Current = __Feedforward_Current;
}

inline void Class_Motor_DM_1_To_4::Set_Encoder_Offset(float __Encoder_Offset) {
  Encoder_Offset = __Encoder_Offset;
}

#endif //RC_ROBOTDOG_REBUILD20260605_MOTOR_DM_H
