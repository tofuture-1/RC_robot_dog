...
void Tim6_Robot_1ms_Callback()
{
    ...
    //dog.Foot1_Left_Back.Set_x_y(0.00,-0.15);
    // dog.Foot2_Right_Back.Set_x_y(0.01,0.06);
    // dog.Foot3_Left_Front.Set_x_y(0.01,0.06);
    // dog.Foot4_Right_Front.Set_x_y(0.01,0.06);
